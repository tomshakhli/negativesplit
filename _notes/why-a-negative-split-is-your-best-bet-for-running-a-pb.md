...
{% include note-figure.html src="/assets/images/notes/london-2023-splits.png" caption="Mile splits from my most recent London Marathon, where I ran a negative split and a PB of 2:49:29" alt="Mile splits from Tom's 2023 London Marathon showing a negative split and a PB of 2:49:29" %}

My fastest 5k segments were the last two, and I had enough energy left at the end to accelerate for the finish. Now, I'm definitely fitter than I was back in 2019, however by adopting this strategy I am confident that I got closer to achieving my fitness potential than had I gone with a more aggressive approach. Maybe I was in 2:45 shape. But at least I didn't end up with 2:55 or slower.
